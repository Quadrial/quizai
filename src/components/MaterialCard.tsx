    ...
    <article className="qa-card qa-card--lift">
      <div className="qa-card__pad">
        <div className="qa-card__header">
          <div className="qa-typeRow">
            <div className={`qa-typeIcon ${typeIconClass}`} aria-hidden="true">
              <Icon className="qa-ico qa-ico--lg" />
            </div>

            <div className="qa-truncate">
              <h3 className="qa-card__title qa-clamp1">{material.name}</h3>
              <p className="qa-card__subtitle">{getTypeLabel()}</p>
            </div>
          </div>
        ...
        <div className="qa-card__meta" style={{ justifyContent: 'flex-start' }}>
        ...
        <div className="qa-card__actions">
          <Link
            to="/create-quiz"
            state={{ selectedMaterial: material }}
            className="qa-btn qa-btn--primary qa-btn--grow"
          >
