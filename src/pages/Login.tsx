    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-on-background mb-2">Welcome to QuizAI</h1>
        ...
        <div className="bg-surface rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="email" className="block text-sm font-semibold text-on-background mb-2">
                Email Address
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <HiUser className="h-5 w-5 text-on-background/40" />
                </div>
                <input
                  type="email"
                  id="email"
                  ...
                  required
                  className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200 bg-surface"
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-semibold text-on-background mb-2">
                Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <HiLockClosed className="h-5 w-5 text-on-background/40" />
                </div>
                <input
                  type="password"
                  id="password"
              ...
              {isSignUp && (
                <p className="text-xs text-on-background/60 mt-1">Password must be at least 6 characters long</p>
              )}
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100">
            <button
              ...
              className="w-full inline-flex items-center justify-center px-6 py-3 bg-surface text-on-surface font-semibold rounded-lg border-2 border-gray-200 hover:bg-surface-200 hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-all duration-200 shadow-sm hover:shadow-md"
            >
              <HiSparkles className="w-5 h-5 mr-2" />
              Continue as Guest
            </button>
            <p className="text-xs text-on-background/60 text-center mt-3 leading-relaxed">
